...
def admin_reply_keyboard() -> ReplyKeyboardMarkup:
    """Reference-matched nested control keyboard for authorized Telegram admins."""
    return ReplyKeyboardMarkup(
        [
            ["📊 Umumiy ko‘rinish", "👥 Faol guruhlar"],
            ["🗂 Jami guruhlar", "📣 E’lonlar"],
            ["⚠️ Alertlar", "🧠 Bot statistikasi"],
            ["👤 So‘nggi faollik", "📤 E’lon yuborish"],
            ["🌐 Javob va yangilik sozlamalari", "⚙️ Guruh sozlamalari"],
            ["🛡 Xavfsizlik holati"],
            ["✅ Tasdiqlash", "📘 Adminlar uchun qo‘llanma"],
            ["🏠 Admin menyu"],
        ],
        resize_keyboard=True,
        is_persistent=True,
