...
Rejalashtirilgan postlar SQLite jadvaliga yoziladi va bot ishlayotgan paytda har 30 soniyada tekshiriladi; Render Free uyquga ketsa yoki standart fayl tizimi tozalansa, bunday jadval uchun persistent disk yoki tashqi baza kerak bo‘ladi. Admin o‘zining asosiy guruhida `/majburiy_qosh @boshqa_guruh 6soat` yoki `/majburiy_qosh -1001234567890 24soat` ni yuborib boshqa guruhni vaqtincha majburiy obunaga qo‘shadi. `12soat`, `24soat` yoki aniq tugash vaqti (`23:00`) ham berish mumkin. Vaqt berilmasa qo‘shilish doimiy bo‘ladi. `/majburiy_royxat` ro‘yxat va tugash vaqtini ko‘rsatadi, `/majburiy_ochir @boshqa_guruh` esa guruhni darhol olib tashlaydi. Aniq soat UTC bo‘yicha hisoblanadi. `/obuna_statistika` admin uchun nechta noyob odam majburiy obunadan o‘tganini bugun, oxirgi 7 kun va umumiy kesimda ko‘rsatadi. Statistikada foydalanuvchi nomlari saqlanmaydi, faqat hisoblar yoziladi. Maxsus `/obuna_kimlar` buyrug‘i esa faqat admin uchun tasdiqlangan foydalanuvchilarning ko‘rinadigan ismi, username’i va UTC vaqtini ko‘rsatadi. Barcha yozuvlar bazada saqlanadi, Telegram xabari juda uzun bo‘lib ketmasligi uchun bir sahifada 40 kishi beriladi: `/obuna_kimlar 2` ikkinchi sahifani, `/obuna_kimlar @guruh 2` esa alohida guruhning ikkinchi sahifasini ko‘rsatadi.
